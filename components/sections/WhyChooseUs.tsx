      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
          ...
          <div className="lg:w-1/2 relative lg:h-[800px]">
            <div className="sticky top-40 bg-white/5 backdrop-blur-xl border border-white/5 p-10 lg:p-12 rounded-[2.5rem] shadow-2xl">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="inline-flex items-center px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-slate-300 text-xs font-bold uppercase tracking-[0.2em] mb-8"
              >
                Why Choose Us
              </motion.div>
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-5xl md:text-6xl font-heading font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-cyan-400 leading-[1.1]"
              >
              ...
              <motion.div
                ...
                className="mt-8 text-slate-400 leading-relaxed max-w-sm text-lg"
              >
          ...
          <div className="lg:w-1/2 flex flex-col gap-10 mt-10 lg:mt-32 relative z-20 pb-24">
            {reasons.map((reason, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden backdrop-blur-xl bg-white/[0.03] rounded-[2rem] p-8 md:p-10 border border-white/10 hover:bg-white/[0.08] transition-colors duration-500 shadow-xl"
              >
                ...
                <h3 className="text-2xl font-heading font-bold text-white mb-4 transition-colors group-hover:text-blue-400 relative z-10 flex border-b border-white/5 pb-4">
                  <span className="text-blue-500/50 mr-4 font-mono font-normal">0{index + 1}</span>
                  {reason.title}
                </h3>
