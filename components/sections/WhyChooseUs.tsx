          ...
          <div className="lg:w-1/2 relative lg:h-[800px]">
            <div className="sticky top-40 bg-zinc-900/5 dark:bg-white/5 backdrop-blur-xl border border-zinc-900/10 dark:border-white/5 p-10 lg:p-12 rounded-[2.5rem] shadow-2xl transition-colors duration-300">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-5xl md:text-6xl font-heading font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 dark:from-blue-400 dark:via-indigo-400 dark:to-cyan-400 leading-[1.1] transition-colors"
              >
